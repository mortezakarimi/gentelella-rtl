        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <p class="text-muted font-13 m-b-30">
                            افزونه Buttons برای DataTables مجموعه ای از گزینه ها، روش های API و یک ظاهر طراحی شده را
                            برای نشان دادن دکمه های صفحه ای که با DataTable ارتباط برقرار می کند، فراهم می کند. کتابخانه
                            هسته ای چارچوب مبتنی بر آن را فراهم می کند که کدام پلاگین ها می توانند ساخته شوند.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <p class="text-muted font-13 m-b-30">
                                        KeyTable قابلیت اکسل مانند را برای ناوبری سلولی در هر جدول فراهم می کند.
                                        رویدادها (تمرکز، تاری، عمل و غیره) را می توان به سلول ها، ستون ها، ردیف ها و یا
                                        تمام سلول ها اختصاص داد.
                                    </p>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <p class="text-muted font-13 m-b-30">
                            Responsive یک افزونه برای DataTables است که این مشکل را با بهینه سازی طرح جدول برای اندازه
                            های مختلف صفحه نمایش از طریق درج پویا و حذف ستون ها از جدول حل می ک
                        </p>
